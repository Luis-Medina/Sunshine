 ...
 */
package com.luismedinaweb.sunshine.data;
...
public class TestDb extends AndroidTestCase {
    ...
    */
    ...
    public void testWeatherTable() {
        ...
        assertTrue("Error: Location Not Inserted Correctly", rowID > 0);
        ...
        long wRowId = db.insert(WeatherContract.WeatherEntry.TABLE_NAME, null, contentValues);
        assertTrue("Error: WeatherEntry was not inserted", wRowId > 0);
        ...
        // query if you like)
        TestUtilities.validateCurrentRecord("Error: Weather query validation failed", c, contentValues);
        ...
        c.close();
        db.close();
        assertFalse("Error: Database was not closed correctly", db.isOpen());
    }
    ...
    public long insertLocation() {
        ...
        assertTrue("Error: Location was not inserted", rowID > 0);
