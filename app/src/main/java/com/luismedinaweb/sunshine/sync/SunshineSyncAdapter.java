package com.luismedinaweb.sunshine.sync;
...
import com.luismedinaweb.sunshine.MainActivity;
import com.luismedinaweb.sunshine.R;
import com.luismedinaweb.sunshine.Utility;
...
public class SunshineSyncAdapter extends AbstractThreadedSyncAdapter {
    ...
    private void doInBackground(Context context) {
        ...
        try {
            ...
            getWeatherDataFromJson(context, forecastJsonStr, location);
        } catch (IOException e) {
     ...
     */
    long addLocation(Context context, String locationSetting, String cityName, double lat, double lon) {
        ...
        if (c.moveToFirst()) {
            ...
            locationID = ContentUris.parseId(context.getContentResolver().insert(uri, contentValues));
    ...
    // Annotations for Location Status
